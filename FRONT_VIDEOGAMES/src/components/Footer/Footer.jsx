...
export default function Footer() {
  return (
    <footer className="bg-slate-100 text-slate-900 dark:bg-gray-400">
      <div className="container flex flex-col p-4 mx-auto md:p-2 lg:flex-row divide-gray-400">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            ...
            >
              <img src={icons.img1} className="transform hover:scale-110 rounded-full shadow-xl shadow-slate-500" alt="" />
            </a>
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-400 text-gray-900"
            >
              <img src={icons.img2} className="transform hover:scale-110 rounded-full shadow-xl shadow-slate-500" alt="" />
            </a>
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-400 text-gray-900"
            >
              <img src={icons.img3} className="transform hover:scale-110 rounded-full shadow-xl shadow-slate-500" alt="" />
            </a>
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-400 text-gray-900"
            >
              <img src={icons.img4} className="transform hover:scale-110 rounded-full shadow-xl shadow-slate-500" alt="" />
            </a>
          </div>
        </div>
      </div>
