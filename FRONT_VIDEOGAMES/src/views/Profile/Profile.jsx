...
export default function Profile(){
  ...
  return (
    ...
    <div>
        ...
        <div class="bg-cover bg-no-repeat h-screen flex w-full"
         style={{backgroundImage: `url('https://www.xtrafondos.com/descargar.php?id=4047&resolucion=3840x2400')`, backgroundSize: 'cover'}}>
